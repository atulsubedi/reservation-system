export default function RestaurantDetails(){
  ...
  <main className="max-w-screen-2xl m-auto bg-white">
    ...
    <div className="text-gray-700 flex m-auto w-2/3 justify-between items-start 0 -mt-11">
      <div className="bg-white w-[70%] rounded p-3 shadow">
        ...
        <div className="text-gray-700 mt-4 border-b pb-6">
            ...
            <div className="border-b pb-7 mb-7">
              <div className="flex">
                <div className="w-1/6 flex flex-col items-center">
                  ...
                  >
                    <h2 className="text-white text-2xl">AS</h2>
                  </div>
                  <p className="text-center">Atulya Subedi</p>
                </div>
      ...
      <div className="w-[27%] relative text-reg">
        <div className="fixed w-[15%] bg-white rounded p-3 shadow">
          ...
          <div className="my-3 flex flex-col">
            ...
            <select name="" className="bg-white py-3 border-b font-light" id="">
          ...
          <div className="flex justify-between">
            <div className=" flex flex-col w-[48%]">
              ...
              <input type="text" className="bg-white py-3 border-b font-light w-28" />
            </div>
            <div className="flex flex-col w-[48%]">
              <label htmlFor="">Time</label>
              <select name="" id="" className="bg-white py-3 border-b font-light">
